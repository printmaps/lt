...
The provided constants are for convenience only. They can help you to assure that all logs within your project have an uniform scheme.
You always can start your logs with a "main category = subcategory" pair, followed by a descriptive "message".

  lt.Format(lt.OPERATIONS, lt.START, lt.MESSAGE, "lt package Format() sample", ...)
  lt.Format(lt.ERROR, lt.FATAL, lt.MESSAGE, "error opening file", ...)
  lt.Format(lt.TRANSACTION, lt.INFO, lt.MESSAGE, "processing startet", ...)
*/
package lt
